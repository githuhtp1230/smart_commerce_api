...
public class AuthenticationService {
    ...
    public void resetPassword(ResetPasswordRequest request) {
        ...
        ForgotPassword forgotPassword = (ForgotPassword) redisService.getObject(request.getEmail());

        if (forgotPassword == null || !user.getEmail().equals(forgotPassword.getEmail())) {
            throw new AppException(ErrorCode.VERIFY_OTP_FAILED);
        }

        if (!forgotPassword.getOtp().equals(request.getOtp())) {
        ...
        Map<String, String> models = new HashMap<>();
        models.put("newPassword", newPassword);
        mailService.sendEmail(user.getEmail(), "Your New Password", models, "reset-password");
    }
