...
public interface CartDetailRepository extends JpaRepository<CartDetail, Integer> {
    ...
    @Query(value = """
            ...
            WHERE cd.user_id = :userId AND cd.id IN :ids
            """, nativeQuery = true)
    List<CartItemResponse> getCartItemsWithListIds(@Param("userId") Integer userId, @Param("ids") List<Integer> ids);
    ...
    @Query(value = """
            ...
            AND (:productVariationId IS NULL OR cd.product_variation_id = :productVariationId)
            """, nativeQuery = true)
    CartItemResponse getItemByUserIdAndProductIdAndProductVariationId(
